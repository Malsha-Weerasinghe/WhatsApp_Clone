...
import { View, FlatList, StyleSheet, Dimensions, Text, TextInput, TouchableOpacity, Button } from 'react-native';
    ...
    <GestureHandlerRootView style={styles.container}>
      <View style={styles.header}>
        ...
        {/* <CameraView facing={facing}> */}
          <Ionicons name="camera-outline" size={25} color={Colors.primary} style={styles.headerIcon} onPress={toggleCameraFacing} />
          {/* </CameraView> */}
          <Ionicons name="create-outline" size={25} color={Colors.primary} style={styles.headerIcon} onPress={() => {navigation.navigate('NewChat')}} />
        </View>
      </View>
